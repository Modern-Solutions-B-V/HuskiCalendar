    ...
    return (
        <>
            <div className="container-fluid">
                <div className="row">
                    {currentView === "week" && (
                        <div className="col pt-md-5 mt-md-5 mt-lg-0 pt-lg-5 d-none d-md-block">
                    ...
                    <div className={currentView !== "month" && currentView !== "agenda" ? "col-md-8 pt-md-3 pt-lg-1  " : "col "}>
                        <Calendar
                            formats={{
